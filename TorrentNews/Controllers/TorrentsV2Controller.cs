namespace TorrentNews.Controllers
{
    ...
    public class TorrentsV2Controller : Controller
    {
        ...
        public ActionResult Starred(int page = 1)
        {
            ...
            var model = this.GetMostRecentModel(
                ...
                0,
                true,
                () => helper.Action("Starred", "TorrentsV2", new { page = page + 1 }),
                () => helper.Action("Starred", "TorrentsV2", new { page = page - 1 }));
        ...
        public ActionResult MostRecent(int page = 1, int minScore = 0)
        {
            ...
            var model = this.GetMostRecentModel(
                ...
                minScore, 
                false,
                () => helper.Action("MostRecent", "TorrentsV2", new { page = page + 1, minScore }),
                () => helper.Action("MostRecent", "TorrentsV2", new { page = page - 1, minScore }));
        ...
        public ActionResult GoToBookmark(int minScore = 0)
        {
            ...
            if (bmTorrent != null)
            {
                var actionUrl = Url.RouteUrl(new { controller = "TorrentsV2", action = "MostRecent", page, minScore });
